...
import {createEthAddress, ethSign, importEthAddress, publicKeyToAddress} from "@/ethereum";
...
describe('ethereum wallet test', () => {
    ...
    test('sign eth eip1559', async () => {
        const rawHex = ethSign({
            "privateKey": "dc2d6117326e9953bc997045df045ea87ebb1c974b49580fafa92fe9a7336ef9",
            "nonce": 8,
    ...
    test('sign eth2 eip1559', async () => {
        const rawHex = ethSign({
            "privateKey": "a482a7dd30e44b8d18ded0ffe6ea0336d46cfad74c22da6a29686b8bdf344bd1",
            "nonce": 7,
            "from": "0xcB1D7AeAa99344D2BEbA6a43BF778AF758568cCc",
            "to": "0xF60Eb3263C138525b6a324aFC9b93c610F60E833",
            "amount": "0.0001",
